...
class AIGymInterface
{
  ...
  public:
    ...
    // void schedule(uint32_t openGymPort)
    // {
    //     Ptr<OpenGymInterface> inter = this->build(openGymPort);
    //     Simulator::Schedule(Seconds(1.0), &AIGymInterface::recordHistory, this);
    //     Simulator::Schedule(Seconds(2.0), &AIGymInterface::ScheduleNextStateRead, sim->envStepTime, inter);
    // }
};
...
void AIGymInterface::recordHistory(void)
{
    static float lastValue = 0.0;
